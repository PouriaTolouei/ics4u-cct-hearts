    ...
    * @oaram cards         - The 1D array of Card objects that will be displayed. */
    private void displayCards(Card[] cards){
        ...
        for (int i = 0; i < cards.length; i++){
            // Checks to make sure that the Card object is not null before displaying it, otherwise it's just skipped.
            if (cards[i] != null){
    ...
    public void ExplainRule(int sectionId) {
        switch(sectionId) {
            ...
            case SECTION_NOTATION: // This section explains the notation used in the game.
                ...
                System.out.println("Ranks: 2, 3, 4, ..., 10, J (Jack), Q (Queen), K (King), A (Ace) (in ascending order)");
